...
var WebView = React.createClass({
  ...
  render: function() {
   ...
   if (this.state.viewState === WebViewState.LOADING) {
      ...
      console.error('MyWebView invalid state encountered: ' + this.state.loading);
    }
  ...
  goForward: function() {
    UIManager.dispatchViewManagerCommand(
      ...
      UIManager.MyWebView.Commands.goForward,
      null
    );
  },
  ...
  goBack: function() {
    UIManager.dispatchViewManagerCommand(
      this.getWebViewHandle(),
      UIManager.MyWebView.Commands.goBack,
      null
    );
  },
  ...
  reload: function() {
    UIManager.dispatchViewManagerCommand(
      this.getWebViewHandle(),
      UIManager.MyWebView.Commands.reload,
      null
    );
  },
