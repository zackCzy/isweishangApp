...
export const GET_RONGIM_LIST='GET_RONGIM_LIST';
...
//bannel
export const GET_HOME_BANNEL = 'GET_HOME_BANNEL';

//chart
export const GET_CHART='GET_CHART';
export const UPDATE_CHART='UPDATE_CHART';
export const CLEAR_MESSAGE_UNREAD='CLEAR_MESSAGE_UNREAD';
export const SEND_CHART='SEND_CHART';