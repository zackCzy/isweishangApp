package com.isweishang.activity.tuiliu;
...
import com.isweishang.data.CreateStreamData;
import com.isweishang.data.LetvStreamData;
import com.isweishang.data.StreamData;
import com.letv.recorder.util.MD5Utls;


public class MainActivity extends Activity {
	// 移动直播推流域名，在官网移动直播创建应用后可拿到
	private static final String DEFAULT_DOMAINNAME = "5044.mpush.live.lecloud.com";
	// 移动直播推流签名密钥，在官网移动直播创建应用后可拿到
	private static final String DEFAULT_APPKEY = "S2ONOLCPCHFUDVIP6WMX";
	...
	private static final String DEFAULT_LETV_USERID = "839830";
	//乐视云直播推流用户私钥，用户可以在官网用户中心拿到
	private static final String DEFAULT_LETV_APPKEY= "101839bd5aaf8276b0f2eef0ee8ddbde";
